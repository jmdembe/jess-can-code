...
export default () => (
    <Layout>
        <div>
            <h2>Things I use..</h2>
            <p>This is a running page of tools that I use inspired to make a page of things I use like the ones used by:</p>
            <ul>
                <li>
            ...
            <p>I am doing this because I am curious in other people's setups, so I want to share in that content! The theme you will see with my setup
            ...
            to set up the mindset that I am working and to not deviate from my work tasks. With that, off we go!</p>
